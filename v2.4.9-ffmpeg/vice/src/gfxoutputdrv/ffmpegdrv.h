...
#ifdef STATIC_FFMPEG
#define VICE_P_AV_PACKET_RESCALE_TS              p_av_packet_rescale_ts
#define VICE_P_AV_INTERLEAVED_WRITE_FRAME        p_av_interleaved_write_frame
#define VICE_P_AVCODEC_CLOSE                     p_avcodec_close
#define VICE_P_AV_FRAME_FREE                     p_av_frame_free
#define VICE_P_AV_FRAME_ALLOC                    p_av_frame_alloc
#define VICE_P_AV_FRAME_GET_BUFFER               p_av_frame_get_buffer
#define VICE_P_AV_DICT_SET                       p_av_dict_set
#define VICE_P_AVCODEC_OPEN2                     p_avcodec_open2
#define VICE_P_AV_DICT_FREE                      p_av_dict_free
#define VICE_P_SWR_FREE                          p_swr_free
#define VICE_P_AVFORMAT_NEW_STREAM               p_avformat_new_stream
#define VICE_P_AV_GET_CHANNEL_LAYOUT_NB_CHANNELS p_av_get_channel_layout_nb_channels
#define VICE_P_SWR_ALLOC                         p_swr_alloc
#define VICE_P_AV_OPT_SET_INT                    p_av_opt_set_int
#define VICE_P_AV_OPT_SET_SAMPLE_FMT             p_av_opt_set_sample_fmt
#define VICE_P_SWR_INIT                          p_swr_init
#define VICE_P_AV_INIT_PACKET                    p_av_init_packet
#define VICE_P_AV_RESCALE_RND                    p_av_rescale_rnd
#define VICE_P_SWR_GET_DELAY                     p_swr_get_delay
#define VICE_P_AV_FRAME_MAKE_WRITABLE            p_av_frame_make_writable
#define VICE_P_SWR_CONVERT                       p_swr_convert
#define VICE_P_AV_RESCALE_Q                      p_av_rescale_q
#define VICE_P_AVCODEC_ENCODE_AUDIO2             p_avcodec_encode_audio2
#define VICE_P_SWS_FREECONTEXT                   p_sws_freeContext
#define VICE_P_SWS_GETCONTEXT                    p_sws_getContext
#define VICE_P_AV_DUMP_FORMAT                    p_av_dump_format
#define VICE_P_AVIO_OPEN                         p_avio_open
#define VICE_P_AVFORMAT_WRITE_HEADER             p_avformat_write_header
#define VICE_P_AV_GUESS_FORMAT                   p_av_guess_format
#define VICE_P_AVCODEC_FIND_ENCODER              p_avcodec_find_encoder
#define VICE_P_AVFORMAT_ALLOC_CONTEXT            p_avformat_alloc_context
#define VICE_P_AV_WRITE_TRAILER                  p_av_write_trailer
#define VICE_P_AVIO_CLOSE                        p_avio_close
#define VICE_P_AV_FREE                           p_av_free
#define VICE_P_SWS_SCALE                         p_sws_scale
#define VICE_P_AVCODEC_ENCODE_VIDEO2             p_avcodec_encode_video2
#define VICE_P_AV_REGISTER_ALL                   p_av_register_all
#else
